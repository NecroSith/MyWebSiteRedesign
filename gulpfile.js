...
gulp.task('server', () => {
    ...
    gulp.watch('./src/scss/**/*.scss').on('change', gulp.series('sass', 'minify-css'));
    gulp.watch('./src/js/**/*.js').on('change', gulp.series('copy:js'));
    gulp.watch('./src/libs/**/*.*').on('change', gulp.series('copy:lib'));
    gulp.watch('./src/img/**/*.*').on('change', gulp.series('optimize-images'));
...
gulp.task('default',
    gulp.series('clean:build', 'clean:css',
    	gulp.parallel('sass','copy:fonts', 'copy:html', 'copy:ico', 'copy:files', 'copy:lib', 'copy:js', 'optimize-images'), 'minify-css', 'server'
    )
);
